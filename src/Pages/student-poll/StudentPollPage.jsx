...
const StudentPollPage = () => {
  ...
  useEffect(() => {
    socket.on("pollCreated", (pollData) => {
      ...
      setTeacherUsername(pollData.teacherUsername);
    });
  ...
  return (
    <>
      <ChatPopover />
      {teacherUsername && submitted && (
        <button
          className="btn rounded-pill ask-question px-4 m-2 position-fixed"
                ...
                <div className="card-body">
                  ...
                  <div className="list-group mt-4">
                    {pollOptions.map((option) => {
                      // Determine the color based on submission and correctness
                      let optionClass = "list-group-item rounded m-1";
                      let optionStyle = {
                        padding: "10px",
                      ...
                      if (submitted) {
                        ...
                        optionClass += " border option-border";
                      }
